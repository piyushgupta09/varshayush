...
<div class="py-5 text-center">
    <p class="display-6 text-secondary text-capitalize">edit venue</p>
</div>
...
<form action="{{ route('venues.update', $venue->id) }}" method="post">
    ...
    <div class="mb-2">
        ...
        <input type="text" name="name" id="name-input" class="form-control" placeholder="Enter venue name"
    ...
    <div class="mb-2">
        ...
        <input type="text" name="address" id="address-input" class="form-control" placeholder="Enter postal address"
