...
window.onload = function () {
  document.getElementById("collapse2FACode").addEventListener("click", showRecoveryCodeInput);
  document.getElementById("collapseRecoveryCode").addEventListener("click", showTfaCodeInput);

  function showRecoveryCodeInput() {
    var tfaCode = document.getElementById("collapse2FACode");
    tfaCode.style.display = 'none';
    var recoveryCode = document.getElementById("collapseRecoveryCode");
